...
public class TCPServer {
	...
	//1. 서버가 먼저 실행되어 클아이언트의 요청을 기다려야한다.
	//2. 클라이언트의 첫번째 요청을 받기위한 소켓이 하나는 늘 열려있어야 한다.
	//		-> 첫 요청을 받기 위해 먼저 열어두고 있는 socket을 serverSocket이라 한다.
	//		-> ServerSocket은 클라이언트의 요청이 들어오면 해당 클라이언트와 통신을 할 socket을 생성해준다.
	...
	public void serverStart() {
		...
		try {
			...
			System.out.println("클라이언트의 요청을 기다라기 있습니다.");
