...
public class StringMethod {
	...
	public void testMethod() {
		...
		System.out.println("str을 대문자로 변환 : " + str1);
		
		//3. str을 모두 소문자로 바꿔주세요.
		//[출력양식] str을 소문자로 변환 : ?
		String str2 = str.toLowerCase();
		System.out.println("str을 소문자로 변환 : " + str2);

		//4. str에 있는 "class"를 "java"로 바꿔주세요
		//java.lang.String.replace()
		//[출력양식] class->java:?
		String str3 = str.replace("class", "java");
		System.out.println("class->java : " + str3);

		//5. str에서 첫번째 v의 위치를 구해주세요.
		//java.lang.String.indexOf()
		//[출력양식] 문자열에서 v의 위치 : ?
		System.out.println("문자열에서 v의 위치 : " + str3.indexOf("v"));

		//6. str의 앞 뒤 공백을 제거해서 출력해주세요
		//java.lang.String.trim()
		//[출력양식] 문자열의 앞뒤 공백제거 : ?
		String str4 = str.trim();
		System.out.println("문자열의 앞뒤 공백제거 : " + str4);
