...
public class StringConcatenation {
	...
	public void stringBuilderConcat() {
		...
		System.out.println("결합전 : " + System.identityHashCode(builder));
		
		//append(String s) : 문자열 결합
		builder.append(" Java Class");
		System.out.println("결합후 : " + System.identityHashCode(builder));
	...
	public void stringBuffer() {
		...
		System.out.println("결합전 : " + System.identityHashCode(buffer));
		
		buffer.append(" Java Class");
		System.out.println("결합후 : " + System.identityHashCode(buffer));
