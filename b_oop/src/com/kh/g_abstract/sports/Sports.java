...
//추상클래스
//추상클래스 클래스의 선언부에 abstract 예약어를 사용함으로써 생성
//추상클래스는 abstract 메서드가 0개 이상 존재하는 클래스
//	* 일반크래스는 abstract 메서드가 0개인 클래스
//	  abstract메서드가 하나라도 있으면 반드시 추상클래스
//abstract 메서드 : 메서드 선언부만 존재하는 메서드. 메서드의 선언부에 abstract
//				예약어를 사용해서 생성
//추상클래스는 미완성 클래스로, 인스턴스화가 불가능하다.
