...
public class Run {
	...
	public static void main(String[] args) {
		...
		Book book1 = new Book("수학의 정서", "나수학", 100);
		Book book2 = new Book("수학의 정서", "나수학", 100);
		...
		//오버라이드 전 : 주소값이 일치하는지 비교 / 동일비교, 주소값이 같은 객체 : 동일객체
		//오버라이드 후 : 주소값이 다르더라도 속성들의 값이 일치하면 같은 객체라고 판다. / 동등비교, 동등객체
		//			주소값 비교 -> 값 비교
		System.out.println("book1과 book2는 동일한 객체인가요? " + (book1 == book2));
		System.out.println("book1과 book2는 동등한 객체인가요? " + book1.equals(book2));
